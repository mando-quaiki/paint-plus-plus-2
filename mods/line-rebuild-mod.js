(function(){
  ...
  function rebuildPipeline(options = {}){
    ...
    const thresh = clamp(options.threshold || 100, 1, 250);
  ...
  panel.innerHTML = `
    ...
    <label>Threshold: <input id="lr_thresh" type="range" min="10" max="240" value="100" style="width:140px"/> <span id="lr_thresh_val">100</span></label>
